// Adiciona um evento de escuta para o envio do formulário
    loginForm.addEventListener("submit", function (event) {
        ...
        const username_forms = document.getElementById("exampleDropdownFormEmail2").value;
        const password_forms = document.getElementById("exampleDropdownFormPassword2").value;
        // const serve para declarar variavél, e no caso, a variável que discorrerá no código terá as informações coletadas de "usuario" do html
            ...
            .then((data) => {
                ...
                if (user) {
                        ...
                        if(userTipo == "medico"){
                            ...
                            var nomeP = user.username;
                            localStorage.setItem("variavel", nomeP );
